...
const EN_TRANS = {
    ...
    landingFengShuiDesc: "Feng Shui (风水) is the ancient Chinese practice of harmonizing individuals with their surrounding environment. It literally translates to 'Wind-Water'. By understanding the flow of Qi (energy), we can optimize our living spaces and our lives for health, wealth, and happiness.",
    landingFaceTitle: "The Mirror of the Soul",
    landingFaceDesc: "Your face is a map of your past, present, and future. Physiognomy, or Mianxiang, is the study of facial features to reveal personality traits and destiny. Our AI combines this ancient art with modern biometric analysis.",
...
const ZH_CN_TRANS = {
    ...
    landingFengShuiDesc: "风水（Feng Shui）是古老的中国实践，旨在使个人与其周围环境和谐相处。字面意思是“风”和“水”。通过理解“气”（能量）的流动，我们可以优化居住空间和生活，从而获得健康、财富和幸福。",
    landingFaceTitle: "灵魂之镜",
    landingFaceDesc: "您的脸庞是您过去、现在和未来的地图。面相学（Mianxiang）是通过研究面部特征来揭示性格特征和命运的学问。我们的 AI 将这一古老艺术与现代生物识别分析相结合。",
...
const ZH_TW_TRANS = {
    ...
    landingFengShuiDesc: "風水（Feng Shui）是古老的中國實踐，旨在使個人與其周圍環境和諧相處。字面意思是“風”和“水”。通過理解“氣”（能量）的流動，我們可以優化居住空間和生活，從而獲得健康、財富和幸福。",
    landingFaceTitle: "靈魂之鏡",
    landingFaceDesc: "您的臉龐是您過去、現在和未來的地圖。面相學（Mianxiang）是通過研究面部特徵來揭示性格特徵和命運的學問。我们的 AI 將這一古老藝術與現代生物識別分析相結合。",
    exploreDestiny: "探索您的天命",
